...
public class ItextpdfBarcodes {

	/** The resulting PDF. */
	private static final String RESULT = "C:\\Users\\YJ\\Desktop\\简历7.pdf";
	...
	public static void main(String[] args) throws IOException,
			DocumentException {
		new ItextpdfBarcodes().createPdf(RESULT);
	}
...
//		}
		...
		document.add(new Paragraph("陈轶 njchenyi@gmail.com"));
		// EAN 13
